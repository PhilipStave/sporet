        ...
        <>
          ...
          {showHelp && (
            <div style={{ marginTop: 12, fontSize: 13, lineHeight: 1.6, display: "grid", gap: 10 }}>
              <div>
                <strong>Enklest — legg til som kontakt (én gang):</strong> Trykk «Legg til som kontakt» og åpne filen.
                Etterpå skriver du bare «Al» i BCC-feltet, så dukker «Altiv logg» opp. Ett tastetrykk per e-post.
              </div>
              <div>
                <strong>Helautomatisk — Outlook-programmet på PC:</strong> Fil → Behandle regler og varsler → Ny regel →
                «Bruk regel på meldinger jeg sender» → Handling «Cc meldingen til personer» →{" "}
                <code style={{ fontSize: 12 }}>{address}</code> → Fullfør. Etter dette logges alt du sender, helt
                automatisk. (Outlook på nett har dessverre ikke regler for sendt e-post.)
              </div>
              <div>
                <strong>Manuelt — når du vil:</strong> Skriv e-posten som vanlig, legg{" "}
                <code style={{ fontSize: 12 }}>{address}</code> i BCC, send.
              </div>
              <div>
